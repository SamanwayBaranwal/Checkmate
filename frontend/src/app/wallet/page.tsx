  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-2">
        ...
        <span className={`text-sm font-bold ${totalNet >= 0 ? 'text-[#46a883]' : 'text-red-400'}`}>
      ...
      <svg viewBox={`0 0 ${W} ${H}`} className="w-full" style={{ height: 80 }} preserveAspectRatio="none">
        ...
        {days.map((d, i) => {
          ...
          const x = i * (barW + gap);
          const fill = d.net >= 0 ? '#46a883' : '#ef4444';
          return (
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-white/5 rounded-xl p-4 text-center">
            ...
            {(starterStatus === 'claimed') && (
              <p className="text-[#46a883] text-sm font-semibold">✓ {starterMsg}</p>
            )}
          ...
          {/* Top-up when broke */}
          <div className="bg-white/5 rounded-xl p-4 text-center">
            <div className="text-2xl font-bold text-[#46a883] mb-1">$5</div>
            ...
            {topupStatus === 'claimed' && (
              <p className="text-[#46a883] text-sm font-semibold">✓ {topupMsg}</p>
            )}
            {topupStatus === 'error' && (
          ...
          {referral.referralLink ? (
            <>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="bg-white/5 rounded-lg p-3 text-center">
                  <div className="text-xl font-bold text-[#46a883]">${referral.referralEarnings.toFixed(2)}</div>
              ...
              {transactions.map((tx) => {
                ...
                return (
                  <tr key={tx.id} className="border-b border-white/5 hover:bg-white/5">
                    ...
                    <td className={`px-4 py-2 text-right font-semibold ${positive ? 'text-[#46a883]' : 'text-red-400'}`}>
