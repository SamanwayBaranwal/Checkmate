...
export default function MatchmakingModal({ onClose, balance, token }: Props) {
  ...
  const joinQueue = useCallback(() => {
    ...
    socket.emit('join_queue', { tier: selectedTier });
  ...
  }, [selectedTier, balance, token, router, onClose]);
      ...
      <div className="card w-full max-w-md mx-4" onClick={(e) => e.stopPropagation()}>
        ...
        {!searching ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm text-white/60 mb-6">Bet: ${selectedTier} USDC · Time control: 5+0</p>
